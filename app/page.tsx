...
function TestimonialsSection() {
  // UseInView placeholder - replace with your actual library import if needed
  ...
  return (
    <section className="bg-[#F5F5F2] py-20 overflow-hidden">
            ...
            {testimonials.map((testimonial, idx) => (
              <div key={testimonial.id} className="w-full flex-shrink-0 px-2">
                <div className="bg-white rounded-2xl shadow-lg p-8 md:p-16 text-center">
                  ...
                  {/* Quote Icon */}
                  <div className={`flex justify-center text-[#a98946] mb-8 transition-all duration-500 ${
                    currentIndex === idx ? 'opacity-100 scale-100' : 'opacity-0 scale-90'
                  }`}>
                    <svg className="w-12 h-12 opacity-40" fill="currentColor" viewBox="0 0 32 32">
                      <path d="M9.352 4C4.456 7.456 1 13.12 1 19.36c0 5.088 3.072 8.064 6.624 8.064 3.36 0 5.856-2.688 5.856-5.856 0-3.168-2.208-5.472-5.088-5.472-.576 0-1.344.096-1.536.192.48-3.264 3.552-7.104 6.624-9.024L9.352 4zm16.512 0c-4.8 3.456-8.256 9.12-8.256 15.36 0 5.088 3.072 8.064 6.624 8.064 3.264 0 5.856-2.688 5.856-5.856 0-3.168-2.304-5.472-5.184-5.472-.576 0-1.248.096-1.44.192.48-3.264 3.456-7.104 6.528-9.024L25.864 4z" />
                    </svg>
                  </div>

                  {/* Testimonial Text */}
                  <p className={`text-gray-700 text-xl md:text-2xl font-light italic leading-relaxed mb-10 transition-all duration-700 delay-200 ${
                  ...
                  <div className={`transition-all duration-700 delay-400 ${
                    ...
                    <p className="text-[#a98946] font-medium text-sm tracking-wide uppercase">{testimonial.title}</p>
                  </div>
                </div>
              </div>
            ))}
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`transition-all duration-300 rounded-full ${
                  index === currentIndex
                    ? 'w-10 h-2 bg-[#a98946]'
                    : 'w-2 h-2 bg-gray-300 hover:bg-[#a98946]/50'
                }`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              ...
              <a href="/contact" className="text-xs font-medium text-gray-600 hover:text-[#232b7c] transition-colors relative group">
                CONTACT
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#232b7c] group-hover:w-full transition-all duration-300"></span>
              </a>
            </div>
